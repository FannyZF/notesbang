...
const SECTIONS = {
  en: [
    ...
    ["7. Your rights", "You can access, correct, export and delete your data from the app. Where GDPR/CCPA apply you have rights to access, portability, erasure and objection."],
    ["8. Contact", "Privacy requests: reach us from inside the product. A dedicated privacy contact will be finalized before public launch."],
  ],
  zh: [
    ...
    ["7. 你的权利", "你可在应用内访问、更正、导出与删除你的数据。在适用 GDPR/CCPA 时，你享有访问、可携、删除与反对处理的权利。"],
    ["8. 联系我们", "隐私相关请求可在产品内联系我们；专门的隐私联系方式将在正式上线前确定。"],
  ],
} as const;
